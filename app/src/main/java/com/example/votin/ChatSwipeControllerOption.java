...
public abstract class ChatSwipeControllerOption extends ItemTouchHelper.SimpleCallback {
    ...
    public ChatSwipeControllerOption(Context context, RecyclerView recyclerView, int buttonWidth) {
        super(0, ItemTouchHelper.LEFT);
        this.recyclerView = recyclerView;
        this.buttonList = new ArrayList<MyButton>();
        this.gestureDetector = new GestureDetector(context, gestureListener);
        this.recyclerView.setOnTouchListener(onTouchListener);
        this.buttonBuffer = new HashMap<Integer, List<MyButton>>();
    ...
    public class MyButton {
        // private String text;
        private int imagesResId, textSize, color, pos;
        private RectF clickRegion;
        private MyButtonClickListener listener;
        private Context context;
        private Resources resources;

        public MyButton(Context context , int imagesResId, int color, MyButtonClickListener listener) {
            // this.text = text;
        ...
        public void onDraw(Canvas c, RectF rectF, int pos) {
          ...
          // } else {
                ...
                p.setColor(Color.parseColor("#2E86C1"));

                Drawable d = ContextCompat.getDrawable(context, imagesResId);
